 ...
 * Note: checkout session and country are NOT passed to startCheckout() here — they are
 * provided later via updateCheckoutSession() after the user enters them.
 */
class CheckoutCompleteActivity : ComponentActivity() {
